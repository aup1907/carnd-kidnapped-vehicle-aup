...
void ParticleFilter::prediction(double delta_t, double std_pos[], double velocity, double yaw_rate) {
    ...
    normal_distribution<double> particle_x(0, std_pos[0]);
    normal_distribution<double> particle_y(0, std_pos[1]);
    normal_distribution<double> particle_theta(0, std_pos[2]);
